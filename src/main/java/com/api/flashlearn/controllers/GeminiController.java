...
public class GeminiController {
    ...
    public ResponseEntity<?> createSummary(@RequestBody GeminiRequest request) {
        ...
        if (summary == null) {
            return ResponseEntity.badRequest().body(Map.of("error", "Failed to generate summary"));
        }
    ...
    public ResponseEntity<?> createFlashcards(@RequestBody GeminiRequest request) {
        ...
        if (flashcardDtos == null) {
            return ResponseEntity.badRequest().body(Map.of("error", "Failed to generate flashcards"));
        }
